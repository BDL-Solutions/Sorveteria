  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <p class="idProduto" style="display: none;">109</p>
        ...
        <p><strong class="text-primary h4 preco">R$50.00</strong></p>
        ...
        <p><a href="cart" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary btn-adicionar-carrinho">Adicionar ao Carrinho</a></p>
      </div>
    </div>
  </div>
</div>
