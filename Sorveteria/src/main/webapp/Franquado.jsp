   ...
   <div class="container">
      <div class="row">
         <div class="col-md-6 ml-auto order-md-2 align-self-start">
            <div class="site-block-cover-content">
               <h2 class="title" style="color: #CF793C;">Agora falta pouco para realizar seus sonhos, torne-se um franqueado</h2>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="h3 mb-3 text-black">Entre em contato conosco</h2>
          </div>
          <div class="col-md-7">
